...
var listado_palabras = ["CAR", "YELLOW", "BLUE","HTML","FURTHER","ADDRESS","ACTUALLY","REASON","REMAIN",
"REASON","REMAIN","ESTABLISH","DESCRIBE","DISCOVER","DURING","MEMORY","METHOD","MIND","MOTHER","NECESSARY",
"RESPONSABILITY","SHOULDER","SOMETIMES","STATEMENT","WINDOWS"];

var acertadas = 0;
var timer, indice;
var tiempo = 60;

function comerzarJuego(){
    //se deja visible la pantalla  y se oculta  la segunda ventana
...
function restarTiempo(){
    ...
    if(tiempo == 0){
        ...
        document.getElementById("cantidad_fnal").innerHTML = acertadas;
